    ...
    <div class="col-12 ml-5 mr-5">
      <form @submit.prevent="createReview">
        <div class="mb-3">
          ...
          <input v-model="editableReviewData.title" class="form-control input-body" id="title" name="title" type="text"
            required minlength="3" maxlength="50" placeholder="Title your review">
        </div>
        <label class="form-label" for="gameplay-score">Gameplay Score</label>
        <select v-model="editableReviewData.gameplayScore" class="form-select input-body" name="gameplay-score"
          id="gameplay-score" placeholder="Gameplay Score" min="1" max="10" required>Gameplay Score
        ...
        <select v-model="editableReviewData.storyScore" class="form-select input-body" name="story-score"
          id="story-score" min="1" max="10" required>Story Score
          <option value="1">1</option>
          <option value="2">2</option>
          <option value="3">3</option>
          <option value="4">4</option>
        ...
        <select v-model="editableReviewData.graphicsScore" class="form-select input-body" name="graphics-score"
          id="graphics-score" min="1" max="10" required>Graphics Score
          <option value="1">1</option>
          <option value="2">2</option>
          <option value="3">3</option>
          <option value="4">4</option>
        ...
        <select v-model="editableReviewData.alphaScore" class="form-select input-body" name="alpha-score"
          id="alpha-score" min="1" max="10" required>Alpha Score
          <option value="1">1</option>
          <option value="2">2</option>
          <option value="3">3</option>
          <option value="4">4</option>
        ...
        <textarea v-model="editableReviewData.body" rows="15" class="w-100 form-control input-body" name="body"
          maxlength="5000" minlength="3" id="body" type="text"
